...
from app.dependencies import get_db # Asume que tienes un archivo app/dependencies.py con get_db
...
def listar_estados(db: Session = Depends(get_db)):
    ...
    return [{"id": estado.id, "nombre": estado.nombre, "categoria": estado.categoria} for estado in estados]
