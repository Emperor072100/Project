...
async def crear_entrega(entrega: EntregaCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        implementacion = (
            db.query(ProjectImplementacionesClienteImple)
            .filter(ProjectImplementacionesClienteImple.id == entrega.implementacion_id)
            .first()
        )
        ...
        nueva_entrega = ProjectEntregaImplementaciones(
            ...
            fecha_entrega=(
                datetime.fromisoformat(entrega.fecha_entrega)
        ...
        if "contractual" in datos:
            ...
            nueva_entrega.acuerdo_niveles_servicio = contractual.get(
            ...
            nueva_entrega.unidades_facturacion = contractual.get(
                "unidadesFacturacion", ""
            )
        ...
        if "tecnologia" in datos:
            ...
            nueva_entrega.transferencia_llamadas = tecnologia.get(
                "transferenciaLlamadas", ""
            )
            nueva_entrega.correos_electronicos = tecnologia.get(
                "correosElectronicos", ""
            )
            ...
            nueva_entrega.requisitos_grabacion = tecnologia.get(
                "requisitosGrabacion", ""
            )
            nueva_entrega.entrega_resguardo = tecnologia.get("entregaResguardo", "")
            nueva_entrega.encuesta_satisfaccion = tecnologia.get(
        ...
        if "procesos" in datos:
            ...
            nueva_entrega.proceso_monitoreo_calidad = procesos.get(
...
async def obtener_entregas(
    implementacion_id: Optional[int] = None, db: Session = Depends(get_db)
):
    """
    ...
    if implementacion_id:
        query = query.filter(
            ProjectEntregaImplementaciones.implementacion_id == implementacion_id
        )
...
async def obtener_entrega(entrega_id: int, db: Session = Depends(get_db)):
    ...
    entrega = (
        ...
        .filter(ProjectEntregaImplementaciones.id == entrega_id)
        .first()
    )
...
async def actualizar_entrega(
    entrega_id: int, entrega: EntregaCreate, db: Session = Depends(get_db)
):
    """
    ...
    try:
        ...
        if entrega.fecha_entrega:
            entrega_existente.fecha_entrega = datetime.fromisoformat(
        ...
        if "contractual" in datos:
            ...
            entrega_existente.acuerdo_niveles_servicio = contractual.get(
                "acuerdoNivelesServicio", ""
            )
            ...
            entrega_existente.unidades_facturacion = contractual.get(
                "unidadesFacturacion", ""
            )
        ...
        if "tecnologia" in datos:
            ...
            entrega_existente.transferencia_llamadas = tecnologia.get(
                "transferenciaLlamadas", ""
            )
            entrega_existente.correos_electronicos = tecnologia.get(
                "correosElectronicos", ""
            )
            ...
            entrega_existente.requisitos_grabacion = tecnologia.get(
                "requisitosGrabacion", ""
            )
            entrega_existente.entrega_resguardo = tecnologia.get("entregaResguardo", "")
            entrega_existente.encuesta_satisfaccion = tecnologia.get(
                "encuestaSatisfaccion", ""
            )
        ...
        if "procesos" in datos:
            ...
            entrega_existente.proceso_monitoreo_calidad = procesos.get(
                "procesoMonitoreoCalidad", ""
            )
