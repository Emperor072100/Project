...
Revision ID: 8138d1801481
Revises: 
Create Date: 2025-07-30 07:49:38.718497
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_productos_campanas_id'), table_name='productos_campanas')
    op.drop_table('productos_campanas')
    op.drop_index(op.f('ix_historial_campanas_id'), table_name='historial_campanas')
    op.drop_table('historial_campanas')
    op.drop_index(op.f('ix_facturacion_campanas_id'), table_name='facturacion_campanas')
    op.drop_table('facturacion_campanas')
    op.drop_table('proyecto_tipos')
    op.drop_table('proyecto_equipos')
    op.drop_table('project_tareas')
    op.drop_index(op.f('ix_campanas_campanas_id'), table_name='campanas_campanas')
    op.drop_table('campanas_campanas')
    op.drop_index(op.f('ix_project_proyectos_id'), table_name='project_proyectos')
    op.drop_table('project_proyectos')
    op.drop_index(op.f('ix_campanas_contacto_id'), table_name='campanas_contacto')
    op.drop_table('campanas_contacto')
    ...
    op.drop_index(op.f('ix_campanas_clientes_corporativos_nombre'), table_name='campanas_clientes_corporativos')
    op.drop_index(op.f('ix_campanas_clientes_corporativos_id'), table_name='campanas_clientes_corporativos')
    op.drop_table('campanas_clientes_corporativos')
    # ### end Alembic commands ###
