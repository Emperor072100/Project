...
def crear_tabla_subsecciones_procesos():
    ...
    try:
        ...
        # Leer el archivo SQL
        sql_file_path = os.path.join(os.path.dirname(__file__), 'migrations', 'create_subseccion_procesos_table.sql')
        ...
        print("✅ Tabla 'project_subseccion_implementacion_procesos' creada exitosamente!")
        print("\nAhora puedes:")
