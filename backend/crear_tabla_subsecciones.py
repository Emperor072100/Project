...
def crear_tabla_subsecciones():
    ...
    try:
        sql_file = Path(__file__).parent / 'migrations' / 'create_subseccion_personalizada_table.sql'
        ...
        print("✅ Tabla 'project_implementacion_subseccion_personalizada' creada exitosamente!")
        print("\nAhora puedes:")
