...
def crear_tabla_subsecciones_talento_humano():
    ...
    try:
        sql_file = Path(__file__).parent / 'migrations' / 'create_subseccion_talento_humano_table.sql'
        ...
        print("✅ Tabla 'project_subseccion_implementacion_talento_humano' creada exitosamente!")
        print("\nAhora puedes:")
        print("1. Reiniciar el servidor backend")
        print("2. Crear subsecciones personalizadas en Talento Humano desde el frontend")
