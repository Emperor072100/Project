...
def upgrade():
    ...
    op.add_column(
        "project_implementaciones_clienteimple",
        sa.Column("contractual", sa.JSON(), nullable=True),
    )
    op.add_column(
        "project_implementaciones_clienteimple",
        sa.Column("talento_humano", sa.JSON(), nullable=True),
    )
    op.add_column(
        "project_implementaciones_clienteimple",
        sa.Column("procesos", sa.JSON(), nullable=True),
    )
    op.add_column(
        "project_implementaciones_clienteimple",
        sa.Column("tecnologia", sa.JSON(), nullable=True),
    )
    op.add_column(
        "project_implementaciones_clienteimple",
