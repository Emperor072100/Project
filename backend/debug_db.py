...
def main():
    ...
    if imp1:
        ...
        contractual1 = (
            ...
            .filter_by(cliente_implementacion_id=1)
            .first()
        )
        if contractual1:
            print(
                f"Contractual tabla - Modelo contrato seguimiento: '{contractual1.modelo_contrato_seguimiento}'"
            )
            print(
                f"Contractual tabla - Modelo contrato estado: '{contractual1.modelo_contrato_estado}'"
            )
        ...
        if talento1:
            print(
                f"Talento tabla - Perfil personal seguimiento: '{talento1.perfil_personal_seguimiento}'"
            )
            print(
                f"Talento tabla - Perfil personal estado: '{talento1.perfil_personal_estado}'"
            )
