...
const DetalleProyecto = () => {
  return (
    <div className="w-full bg-white">
      <h1 className="text-xl font-bold mb-2 text-green-600">Detalle del Proyecto</h1>
      <p className="text-gray-600 mb-2">Esta vista mostrará los detalles de un proyecto específico</p>
...
const NuevoProyecto = () => {
  ...
  return (
    <div className="w-full bg-white">
      <h1 className="text-xl font-bold mb-2 text-green-600">Crear Nuevo Proyecto</h1>
      <div className="bg-white rounded-lg shadow-md p-4">
